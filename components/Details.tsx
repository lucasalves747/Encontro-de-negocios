        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-10">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 leading-relaxed">
              <span className="text-brand-gold">24 de Janeiro.</span> <br/>
              {COPY.DETAILS.INTRO}
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-md hover:shadow-lg hover:border-brand-gold/30 transition-all group text-center flex flex-col items-center justify-center">
              ...
              <h3 className="text-base font-bold text-gray-900 uppercase tracking-wide">{COPY.DETAILS.POINTS[0]}</h3>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-md hover:shadow-lg hover:border-brand-gold/30 transition-all group text-center flex flex-col items-center justify-center">
              <TrendingUp className="w-8 h-8 text-brand-gold mb-3 group-hover:scale-110 transition-transform" />
              <h3 className="text-base font-bold text-gray-900 uppercase tracking-wide">{COPY.DETAILS.POINTS[1]}</h3>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-md hover:shadow-lg hover:border-brand-gold/30 transition-all group text-center flex flex-col items-center justify-center">
              <Briefcase className="w-8 h-8 text-brand-gold mb-3 group-hover:scale-110 transition-transform" />
              <h3 className="text-base font-bold text-gray-900 uppercase tracking-wide">{COPY.DETAILS.POINTS[2]}</h3>
            </div>
          </div>
              ...
              <div className="space-y-4 w-full">
                <div className="flex items-center space-x-4 pb-3 border-b border-gray-100">
                  <div className="bg-brand-gold/10 p-2 rounded-full">
                    <MapPin className="text-brand-gold w-5 h-5 flex-shrink-0" />
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-4 pb-3 border-b border-gray-100">
                  <div className="bg-brand-gold/10 p-2 rounded-full">
                    <Calendar className="text-brand-gold w-5 h-5 flex-shrink-0" />
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-3 pt-1">
                  <div className="bg-brand-gold/10 p-2 rounded-full">
                    <Lock className="text-brand-gold w-4 h-4 flex-shrink-0" />
                  </div>
                  <p className="text-sm text-gray-600 font-medium italic">{COPY.DETAILS.DISCLAIMER}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <Button variant="primary" fullWidth={false} className="w-full md:w-auto py-3 shadow-lg hover:shadow-xl text-sm">
              {COPY.DETAILS.CTA}
            </Button>
          </div>
        </div>
